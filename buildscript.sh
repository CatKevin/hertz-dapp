...
ssh leekdao@149.28.181.19 "echo $sudoPW | sudo -S rm -rf /var/www/html/app.leekdao.xyz/*"
ssh leekdao@149.28.181.19 "echo $sudoPW | sudo -S cp -R ~/$BUILD_FOLDER/* /var/www/html/app.leekdao.xyz/"